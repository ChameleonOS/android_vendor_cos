#
# ChameleonOS Audio Files
#

ALARM_PATH := vendor/cos/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cos/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cos/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/cos/prebuilt/common/media/audio/ui
